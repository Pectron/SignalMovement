        ...
        */
        public class StreamInlet
        {
            /**
                    ...
                    */
            public StreamInlet(StreamInfo info, int max_buflen = 360, int max_chunklen = 0, bool recover = true, processing_options_t postproc_flags = processing_options_t.post_none)
            {
